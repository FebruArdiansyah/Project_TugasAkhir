...
import '../widgets/transaction_detail/detail_outbound_header_card.dart';
import '../widgets/transaction_detail/detail_outbound_item_card.dart';
...
class _DetailBarangKeluarScreenState extends State<DetailBarangKeluarScreen> {
  ...
  String get unitName {
    if (items.isEmpty) return 'PCS';

    return _firstNonEmpty([
      items.first['unit_name'],
      items.first['unit'],
      items.first['satuan'],
    ], fallback: 'PCS');
  }
      ...
      body: Stack(
        children: [
          const Positioned.fill(
            child: CustomPaint(
              painter: _DetailOutboundBackgroundPainter(),
            ),
          ),
          SafeArea(
            child: Column(
      ...
      child: Row(
        children: [
          ...
          _HeaderIconButton(
            ...
            onTap: outboundId == null ? null : _loadDetail,
          ),
        ],
      ),
    );
  ...
  Widget _buildHeaderCard(DateTime? transactionDate) {
    return DetailOutboundHeaderCard(
      transactionDate: transactionDate,
      transactionNumber: transactionNumber,
      referenceNumber: referenceNumber,
      outboundType: outboundType,
      partnerLabel: 'Customer / Tujuan',
        ...
        children: [
          if (items.isEmpty)
            ...
            ...items.asMap().entries.map((entry) {
              ...
              final itemWarehouseName = _firstNonEmpty([
                item['warehouse_name'],
                item['gudang'],
                warehouseName,
              ]);

              final itemUnitName = _firstNonEmpty([
                item['unit_name'],
                item['unit'],
                item['satuan'],
              ], fallback: 'PCS');
          ...
          DetailInfoBox(
            ...
            value:
                ...
                'Total qty: ${_formatQty(totalQty)} $unitName\n'
  ...
  Widget _buildLokasiCatatanSection() {
    return _buildSection(
      color: _primaryBlue,
  ...
  Widget _buildEditButton() {
    return DetailEditButton(
      text: 'Edit Pengajuan Barang Keluar',
      color: _primaryRed,
  ...
  Widget _buildLoadingState() {
    return const DetailLoadingState(
      message: 'Memuat detail barang keluar...',
      color: _primaryRed,
    );
  }
  ...
  Widget _buildErrorState() {
    return DetailErrorState(
      ...
      color: _primaryRed,
      onRetry: outboundId == null ? null : _loadDetail,
    );
  }
}
...
class _DetailOutboundBackgroundPainter extends CustomPainter {
  const _DetailOutboundBackgroundPainter();
