...
class DetailHeaderCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final safeInvoice =
        invoiceNumber.trim().isEmpty ? '-' : invoiceNumber.trim();
        ...
        const Expanded(
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 3),
              Text(
                'Detail penerimaan barang gudang',
                maxLines: 1,
                overflow: TextOverflow.ellipsis,
                style: TextStyle(
                  fontSize: 11.5,
        ...
        SizedBox(
          ...
          child: Text(
            ...
            style: const TextStyle(
              fontSize: 10.5,
              color: DetailHeaderCard._softGreen,
              fontWeight: FontWeight.w600,
              height: 1.25,
            ),
          ),
      ...
      child: Row(
        children: [
          Container(
            ...
            child: Icon(
              icon,
              color: DetailHeaderCard._primaryGreen,
              size: 18,
            ),
          ),
          const SizedBox(width: 9),
            ...
            child: Column(
              ...
              children: [
                Text(
                  ...
                  style: const TextStyle(
                    fontSize: 10,
                    color: DetailHeaderCard._softText,
                ...
                Text(
                  ...
                  style: const TextStyle(
                    fontSize: 13,
                    color: DetailHeaderCard._darkText,
                    fontWeight: FontWeight.w900,
                  ),
                ),
